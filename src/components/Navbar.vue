<template>
	<nav class="absolute z-50 w-[100%] mx-[0%] p-6 top-0 flex justify-between items-center bg-white">
		<a class="text-3xl font-['Poppins'] font-bold text-gray-900 tracking-wider" href="#">
            <i class="fa-solid fa-washing-machine text-4xl text-[#5CB8A8] px-2"/>
            Get Clean
		</a>
		<div class="lg:hidden">
		...
		<ul class="hidden absolute top-1/2 right-32 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
			<li><a class="text-base text-gray-500 hover:text-gray-900 font-['Poppins']" href="/">Home</a></li>
			<li class="text-gray-300">
			</li>
			<li><a class="text-base text-indigo-600 font-bold font-['Poppins']" href="/restos">Prices & Services</a></li>
			<li class="text-gray-300">
			</li>
			<li><a class="text-base text-gray-500 hover:text-gray-900 font-['Poppins']" href="#">Address</a></li>
			<li class="text-gray-300">
			</li>
			<li><a class="text-base text-gray-500 hover:text-gray-900 font-['Poppins']" href="#">Contact</a></li>
			<li class="text-gray-300">
			</li>
		</ul>
	...
	<div class="navbar-menu relative z-50 hidden">
		...
		<nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
			...
			<div>
				<ul>
					<li class="mb-1">
						<a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#">How To Work</a>
					</li>
					<li class="mb-1">
