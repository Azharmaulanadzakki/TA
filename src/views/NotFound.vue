	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8 offset-sm-2 text-gray-50 text-center ">
				<div class="relative ">
				<h1 class="relative text-9xl tracking-tighter-less text-shadow font-sans font-bold -mt-40">
				...
				<p class="text-gray-50 mt-2 mb-6 font-bold">we are sorry, but the page you requested was not found</p>
